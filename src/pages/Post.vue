...
import { getPost, getTrendingHot, getTrendingNew } from '@/services/postService';
...
export default {
    ...
    data() {
        return {
            communityId: Number(this.$route.params.cid),
